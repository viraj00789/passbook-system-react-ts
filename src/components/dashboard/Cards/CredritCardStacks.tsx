...
const CardStack = () => {
  ...
  return (
    <>
      <div className="w-full lg:w-[35%] flex flex-col border border-gray-300 dark:border-gray-800 rounded-3xl bg-gray-50 dark:bg-gray-800">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white p-4 lg:p-5">
          Accounts
        </h2>
        <div className="flex items-center justify-center h-full">
          <ul className="relative h-100 lg:h-50 w-[calc(100%-100px)] flex items-center justify-center">
