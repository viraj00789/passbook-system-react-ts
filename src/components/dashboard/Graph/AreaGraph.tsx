...
export default function AreaGraph() {
  ...
  return (
    <div className="my-2 lg:my-0 w-full max-w-full 2xl:max-w-[65%] space-y-4 border-radius-3xl border border-gray-300 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 p-0 md:p-3 xl:p-4">
      {/* Header */}
